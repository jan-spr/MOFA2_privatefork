...
#' The simplest option is \code{\link[reticulate]{py_require}} (e.g. \code{reticulate::py_require("mofapy2", python_version = "3.12")}) 
...
#' \dontrun{ 
#' reticulate::py_require("mofapy2", python_version = "3.12")
...
run_mofa <- function(object, outfile = NULL, save_data = TRUE, use_basilisk = FALSE) {
  ...
  if (!use_basilisk) {
    ...
    Please make sure mofapy2 is available to reticulate, e.g. by declaring it with reticulate::py_require('mofapy2') or by selecting an existing installation with reticulate::use_python('/path/to/python', required = TRUE).

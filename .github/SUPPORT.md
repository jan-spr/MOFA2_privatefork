# Getting help with `MOFA2`

Thank you for using `MOFA2`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/MOFA2`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/MOFA2),
...
[search issues and pull requests](https://github.com/jan-spr/MOFA2_privatefork/issues)

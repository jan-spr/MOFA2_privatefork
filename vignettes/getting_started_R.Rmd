...
- **Seurat** (or **SingleCellExperiment**): for single-cell genomics users. 
See [this vignette](https://htmlpreview.github.io/?https://github.com/bioFAM/MOFA2_tutorials/blob/master/R_tutorials/scRNA_gastrulation.html).
...
[check this vignette](https://htmlpreview.github.io/?https://github.com/bioFAM/MOFA2_tutorials/blob/master/R_tutorials/scRNA_gastrulation.html). 
...
Train the MOFA model. Remember that in this step the `MOFA2` R package connects with the
`mofapy2` Python package using `reticulate`. This is the source of most problems when
running MOFA. See our [installation notes](https://biofam.github.io/MOFA2/installation.html#notes-on-the-connection-of-r-to-python)
...
reticulate::py_require("mofapy2==0.7.3", python = "3.12")
...
To continue with the downstream analysis, follow [this tutorial](https://htmlpreview.github.io/?https://github.com/bioFAM/MOFA2_tutorials/master/R_tutorials/downstream_analysis.html)
